            ...
            <div class="col-md-12">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>   
                            <a href="{{ route('typeproduit.show', 
                            $pro->typeproduit->id) }}">
                                {{ $pro->typeproduit->libelle }}
                            </a>
                        </th>
                        <th>{{$pro->prix}}</th>
                        <th>{{$pro->qtStock}}</th>
                        <th>
                            {{-- <form method="POST" method=" {{url('cv/'.$cv->id.'/edite') }}"> --}}
                                <form action="{{route('produit.destroy',['produit'=> $pro])}}" method="POST">
                                    
                                    {{ csrf_field() }}
                                    {{method_field('DELETE')}}
                                    <a href="{{route('produit.show',['produit'=> $pro])}}" class="btn btn-primary">
                                    ...
                                    <a href="{{route('produit.edit',['produit'=> $pro])}}" class="btn btn-warning" >
