@extends('layouts.app')
@section('content')
{{-- <title>{{ yield'app.name', 'Gestion commande'}}</title> --}}
                    ...
                    <tr>
                        ...
                        <th>
                            {{-- <form method="POST" method=" {{url('cv/'.$cv->id.'/edite') }}"> --}}
                                <form action="{{route('clients.destroy',['client'=>$cl])}}" method="POST">
                                    
                                    {{ csrf_field() }}
                                    {{method_field('DELETE')}}
                                    <a href="{{route('clients.show',['client'=>$cl])}}" class="btn btn-primary">
                                    ...
                                    <a href="{{route('clients.edit',['client'=>$cl])}}" class="btn btn-warning">
