...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
            @if (session('message'))
                <div id="suc" class="alert alert-warning" role="alert">
                    {{ session('message') }}
                </div>
            @endif
            <div class="float-end">
                <a href="{{route('utilisateur.create')}}">New Utilisateure</a>
            </div>
        <table class="table">
            <thead>
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{route('utilisateur.destroy', $utilisateur->id)}}" method="POST">
                                ...
                                {{ csrf_field() }}
                                {{method_field('DELETE')}}
                                <a href="{{route('utilisateur.show', $utilisateur->id) }}" class="btn btn-primary">
                                ...
                                <a href="{{route('utilisateur.edit', $utilisateur->id) }}" class="btn btn-warning" >
        ...
        <div class="d-flex">{{ $utilisateurs->links() }}</div>
    </div>
@endsection
